...
describe('The Interest component', () => {
  ...
  it('Performs updates', () => {
    ...
    component.find('.relinquished input[name="month"]').simulate('change', { target: { value: '2' } })
    component.find('.relinquished input[name="year"]').simulate('change', { target: { value: '2010' } })
    component.find('.not-applicable input[name="RelinquishedNotApplicable"]').simulate('change')
