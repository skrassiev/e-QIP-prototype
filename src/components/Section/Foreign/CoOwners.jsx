...
export default class CoOwners extends ValidationElement {
  ...
  render () {
    const prefix = this.props.prefix ? `${this.props.prefix}.coOwners` : 'coOwners'
    return (
      <div className="co-owners">
        <BranchCollection className="appeals"
          label={i18n.t(`foreign.${prefix}.heading.hasCoOwners`)}
          appendLabel={i18n.t(`foreign.${prefix}.heading.hasCoOwnersAppend`)}
